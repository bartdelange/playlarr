...
export function productionJobHandlers(database: Database.Database, config: AppConfig, settings: SettingsRepository): Record<string, JobHandler> {
  ...
  return { playlist_acquisition: acquisition, resolution, resolution_retry: resolution, lidarr_planning: lidarrPlanning, lidarr_execution: lidarrExecution, playlist_generation: generation };
}
